...
def add_cell_to_notebook(notebook_path, cell):
    # Read the notebook
...
'''
    ...
    folder = r"/Users/daniel/Desktop/CS3 Exams/Exam 3/Input"


    # Process each .ipynb file in the folder
    for filename in os.listdir(folder):
        if filename.endswith('.ipynb'):
            notebook_path = os.path.join(folder, filename)
            ...
            add_cell_to_notebook(notebook_path, cell)
